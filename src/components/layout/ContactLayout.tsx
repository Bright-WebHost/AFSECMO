...
const projectFields = [
  {
    label: "Project type",
    name: "projectType",
    placeholder: "Industrial expansion, site optimisation, digital integration...",
    type: "text",
  },
  {
    label: "Estimated timeline",
    name: "timeline",
    placeholder: "Q3 2026 / 6–12 months",
    type: "text",
  },
  {
    label: "Budget range",
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between gap-10">
          <div className="space-y-8">
            <div className="space-y-3">
              <p className="text-sm uppercase tracking-[0.35em] text-white/50">Contact Details</p>
              <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
                Reach the AFSECMO team.
              </h1>
            </div>

            <div className="grid gap-6 rounded-3xl border border-white/10 bg-white/5 p-6">
              <div>
                <p className="text-sm uppercase tracking-[0.32em] text-white/50">Office</p>
                <p className="mt-3 text-base text-white/80">21 Industrial Drive, London, UK</p>
              </div>
              <div>
                <p className="text-sm uppercase tracking-[0.32em] text-white/50">Email</p>
                <a href="mailto:contact@afsecmo.com" className="mt-3 block text-base text-white/90 hover:text-[#FF8C00]">
                  contact@afsecmo.com
                </a>
              </div>
              <div>
                <p className="text-sm uppercase tracking-[0.32em] text-white/50">Phone</p>
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              <p className="text-sm uppercase tracking-[0.32em] text-white/50">Find us</p>
              <div className="mt-4 overflow-hidden rounded-3xl border border-white/10 bg-primary">
                <iframe
                  title="AFSECMO office map"
        ...
        <div className="relative mx-auto max-w-2xl">
          <div className="mb-8 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_28px_90px_rgba(0,0,0,0.18)]">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm uppercase tracking-[0.35em] text-white/50">Inquiry form</p>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {step === 2 && (
                  <div className="space-y-5">
                    <label className="block text-sm text-white/70">
                      <span className="mb-3 block text-sm font-semibold text-white">Project brief</span>
                      <textarea
                        name="message"
                        value={formData.message}
                        onChange={handleChange}
                        placeholder="Briefly describe the scope, objectives, and any key requirements."
                        rows={6}
                        className="w-full rounded-3xl border border-white/10 bg-tertiary/60 px-5 py-4 text-white outline-none transition focus:border-[#FF8C00] focus:ring-4 focus:ring-[#FF8C00]/40"
                        required
                      />
                ...
                <div className="flex flex-col gap-4 pt-2 sm:flex-row sm:justify-between">
                  ...
                  >
                    {step === 2 ? "Submit inquiry" : "Continue"}
                  </button>
                </div>
              </motion.form>
            </AnimatePresence>
